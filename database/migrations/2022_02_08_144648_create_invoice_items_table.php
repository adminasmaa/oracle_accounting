...
class CreateInvoiceItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_items', function (Blueprint $table) {
            ...
            $table->string('serial_number_id')->nullable()->index();
            $table->string('invoice_update')->nullable()->index();
            $table->string('profit')->nullable()->index();
            $table->string('total_price_quantity')->nullable()->index();
            $table->timestamps();
