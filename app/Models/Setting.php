...
class Setting extends Model
{
    ...
    protected $fillable = [
        'company_name', 'company_phone', 'company_email', 'company_address', 'discount_earned_account_index_id', 'allowed_discount_account_index_id', 'suppliers_account_index_id', 'customers_account_index_id', 'salary_account_index_id', 'company_manager', 'company_description', 'payment_parchasing_account_index_id', 'payment_selling_account_index_id', 'inbox_account_index_id'
    ];
    ...
    {
        return $this->hasOne(Attachment::class)->orderBy('id','DESC');
    }
    ...
    public function suppliers_account_index()
    {
        return $this->belongsTo(IndexAccount::class, 'suppliers_account_index_id');
    }
