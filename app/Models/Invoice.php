...
class Invoice extends Model
{
    ...
    protected $fillable = [
        'invoice_number', 'description', 'invoice_date', 'last_invoice_payment_date', 'invoice_payment_date', 'total_price', 'sub_total', 'status', 'type', 'user_id', 'index_account_id', 'is_active', 'balanceUser'
    ];
    ...
    public function getArrestResebtAttribute()
    {
        ...
        foreach ($this->arrest_receipts as $arrest) {
            $arrestQuantity = $arrestQuantity + ($arrest->batch_quantity);

        }
        return $arrestQuantity;
    }
