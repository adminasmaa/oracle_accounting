...
class InvoiceItem extends Model
{
    ...
    protected $fillable = [
        'description', 'item_name', 'invoice_id', 'item_id', 'user_id', 'index_account_id', 'purchasing_price', 'unit_id', 'selling_price', 'quantity', 'total_price_quantity', 'invoice_update', 'serial_number_id', 'profit'
    ];
