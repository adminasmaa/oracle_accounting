<div class="d-inline">
    <button type="button" class="btn btn-sm text-danger border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormDeleteInvoiceItem{{$invoice_item->id}}">
        <i class="fa fa-trash"></i>
    </button>
    <div wire:ignore.self class="modal fade modalFormDeleteInvoiceItem{{$invoice_item->id}}" id="" tabindex="-1"
