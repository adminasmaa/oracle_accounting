<div>
    ...
    <a type="button" class="btn btn-primary mb-3" href="{{route('expenses.create')}}" title="عرض"> + اضف </a>
    ...
    @else
        <div class="mb-3 text-center p-1 fs-4 py-3">
            <div><img width="200" src="{{ asset('assets/images/Error.png') }}" alt=""></div>{{ __('Empty expenses') }}
        </div>
    @endif
