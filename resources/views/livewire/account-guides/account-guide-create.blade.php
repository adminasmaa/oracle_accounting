<div class="d-inline">
    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalFormAccountGuide">
        انشاء دليل حساب
    </button>

    <div wire:ignore.self class="modal fade" id="modalFormAccountGuide" tabindex="-1" role="dialog"
