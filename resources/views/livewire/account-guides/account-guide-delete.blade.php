<div class="d-inline">
    ...
    <button type="button" class="btn btn-sm text-danger border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormDeleteAccountGuide{{$account_guide->id}}">
        <i class="fa fa-trash"></i>
    </button>
    <div wire:ignore.self class="modal fade modalFormDeleteAccountGuide{{$account_guide->id}}" id="" tabindex="-1"
