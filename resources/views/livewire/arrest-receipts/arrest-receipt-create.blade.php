<div class="d-inline">
        ...
        <form wire:submit.prevent="store" class="modal-body">
            ...
            <div class="row justify-content-center">
                <div class="form-group col-12">
                    ...
                    <input name="arrest_receipt.type" name="type" type="hidden" value="{{ $invoice->type }}"
                           class="form-control">

                    <input wire:model.defer="arrest_receipt.batch_quantity"
    ...
    @else
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                data-bs-target="#modalFormArrestReceiptsCreate">
        ...
        <div wire:ignore.self class="modal fade" id="modalFormArrestReceiptsCreate" tabindex="-1" role="dialog"
                ...
                <div class="modal-content rounded-4 px-2">
                    ...
                    <form wire:submit.prevent="store" class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            @error('arrest_receipt.user_id') <span
                                    class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="">كمية الدفعة</label>
                            {{ $invoice->type}}
                            <input wire:model.defer="arrest_receipt.type" type="text" value="{{ $invoice->type }}"
                                   class="form-control">
