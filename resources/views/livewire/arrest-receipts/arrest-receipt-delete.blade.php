<div class="d-inline">
    ...
    <button type="button" class="btn btn-sm text-danger border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormDeleteArrestReceipt{{$arrest_receipt->id}}">
        <i class="fa fa-trash"></i>
    </button>
    <div wire:ignore.self class="modal fade modalFormDeleteArrestReceipt{{$arrest_receipt->id}}" id="" tabindex="-1"
