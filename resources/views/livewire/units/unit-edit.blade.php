<div class="d-inline">
    <button type="button" class="btn btn-sm text-primary border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormEditUnit{{$unit['id']}}">
        <i class="fa fa-edit"></i>
    </button>

    <div wire:ignore.self class="modal fade modalFormEditUnit{{$unit['id']}}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-4 px-2">
                ...
                <form wire:submit.prevent="update" class="modal-body">
                    ...
                    <select wire:model.defer="unit.item_id" name="category_id" class="form-select">
