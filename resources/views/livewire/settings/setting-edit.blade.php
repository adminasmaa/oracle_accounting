<div class="d-inline">
    <button type="button" class="btn btn-sm text-primary border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormEditSetting{{$setting['id']}}">
        <i class="fa fa-edit"></i>
    </button>

    <div wire:ignore.self class="modal fade modalFormEditSetting{{$setting['id']}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-content rounded-4 px-2">
                ...
                <form wire:submit.prevent="update" class="modal-body">
                    ...
                    <div class="form-group col-6 mt-3">
                        ...
                        <select wire:model.defer="setting.payment_selling_account_index_id" name="index_account_id"
                                class="form-control">
                    ...
                    <div class="form-group col-6 mt-3">
                        ...
                        <select wire:model.defer="setting.payment_parchasing_account_index_id" name="index_account_id"
                                class="form-control">
                            <option value="">{{ __('Nothing') }}</option>
                            @foreach($index_accounts as $index_account)
                                <option value="{{ $index_account->id }}">{{ $index_account->account_name }}</option>
                    ...
                    <div class="form-group col-6 mt-3">
                        ...
                        <select wire:model.defer="setting.discount_earned_account_index_id" name="index_account_id"
                                class="form-control">
                            <option value="">{{ __('Nothing') }}</option>
                            @foreach($index_accounts as $index_account)
                                <option value="{{ $index_account->id }}">{{ $index_account->account_name }}</option>
                    ...
                    <div class="form-group col-6 mt-3">
                        ...
                        <select wire:model.defer="setting.allowed_discount_account_index_id" name="index_account_id"
                                class="form-control">
                            <option value="">{{ __('Nothing') }}</option>
                            @foreach($index_accounts as $index_account)
                                <option value="{{ $index_account->id }}">{{ $index_account->account_name }}</option>
