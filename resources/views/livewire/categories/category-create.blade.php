<div class="d-inline">
    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalFormCategory">
        انشاء قسم
    </button>

    <div wire:ignore.self class="modal fade" id="modalFormCategory" tabindex="-1" role="dialog"
