<div class="d-inline">
    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalFormSerialNumber">
        انشاء رقم تسلسلي
    </button>

    <div wire:ignore.self class="modal fade" id="modalFormSerialNumber" tabindex="-1" role="dialog"
            ...
            <div class="modal-content rounded-4 px-2">
                ...
                <form wire:submit.prevent="store" class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.defer="serial_number.item_id" name="item_id" class="form-select">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="serial_number.status" name="status" class="form-select">
