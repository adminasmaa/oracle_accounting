<div>
    ...
    <div class="row">
        <table class="table table-striped table-responsive-sm border w-50">
            ...
            <tr>
                <th scope="col" class="text-center"> الحساب الكلي</th>
                <td>{{ $total }}</td>
            </tr>
            <tr>
                <th scope="col" class="text-center"> الخصم</th>
                <td>{{ $discount }}</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <livewire:users.user-edit :user_id="$user->id"
                                              :key="'user-edit-user-show-'.$user->id"></livewire:users.user-edit>
                    <livewire:users.user-delete :user_id="$user->id"
                                                :key="'user-delete-user-show-'.$user->id"></livewire:users.user-delete>
                </td>
            </tr>
            </thead>
        </table>
