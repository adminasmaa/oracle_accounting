<div class="d-inline">
    ...
    <button type="button" class="btn btn-sm text-danger border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormDeleteInvoiceDiscount{{$invoice_discount->id}}">
        <i class="fa fa-trash"></i>
    </button>
    <div wire:ignore.self class="modal fade modalFormDeleteInvoiceDiscount{{$invoice_discount->id}}" id="" tabindex="-1"
