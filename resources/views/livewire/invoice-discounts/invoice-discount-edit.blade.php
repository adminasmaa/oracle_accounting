<div class="d-inline">
    <button type="button" class="btn btn-sm text-primary border-end" data-bs-toggle="modal"
            data-bs-target=".modalFormEditInvoiceDiscount{{$invoice_discount['id']}}">
        <i class="fa fa-edit"></i>
    </button>

    <div wire:ignore.self class="modal fade modalFormEditInvoiceDiscount{{$invoice_discount['id']}}" tabindex="-1"
            ...
            <div class="modal-content rounded-4 px-2">
                ...
                <form wire:submit.prevent="update" class="modal-body">
                    <div class="form-group">
                        ...
                        <select wire:model.defer="invoice_discount.invoice_id" name="invoice_id" class="form-select">
