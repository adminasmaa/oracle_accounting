<div class="d-inline">
    ...
    <!-- Modal -->
    <div class="modal fade" id="ModalProfileEdit-{{auth()->id()}}-" tabindex="-1"
         aria-labelledby="ModalProfileEdit-{{auth()->id()}}-Label"
         aria-hidden="true"
         wire:ignore.self>
            ...
            <div class="modal-content rounded-4 px-2">
                <div class="modal-header edit-data">
                    <h5 class="modal-title ms-auto"
                        id="ModalProfileEdit-{{auth()->id()}}-Label">{{ __('Edit profile') }}</h5>
                    <button type="button" class="btn-close btn-sm p-0 m-0" data-bs-dismiss="modal"
