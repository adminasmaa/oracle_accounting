<div>
    @if($invoice_items->count())
                                ...
                                <div class="text-95 text-secondary-d3">
                                    ...
                                    @foreach($invoice_items as $invoice_item)
                                        ...
                                        <div class="row mb-2 mb-sm-0 py-25 bgc-default-l4">
                                            <div class="d-none d-sm-block col-1"><a
                                                        href="{{ route('items.show', ['item_id' => $invoice_item->item_id]) }}">{{ $invoice_item->item_id }}</a>
                                            </div>
                                        ...
                                        <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                            ...
                                            <div class="col-5">
                                                ...
                                                <span class="text-150 text-success-d3 opacity-2">{{$total - ($alldesc +$arrestval)}}</span>
                                                    <?php $subtotal = $total - $alldesc ?>

                                                    <?php $totalprice = $total - ($alldesc + $arrestval) ?>
        ...
        <button wire:click="updateActivite({{$subtotal}},{{$totalprice}})" type="button" class="btn btn-primary mb-3" >
            حفظ
        </button>
